...
struct OpenAIService: LLMService {
    ...
    private static func displayName(for id: String) -> String {
        ...
        case "gpt-4.1":      baseName = "GPT-4.1"
        case "gpt-4.1-mini": baseName = "GPT-4.1 mini"
        case "gpt-4.1-nano": baseName = "GPT-4.1 nano"
        ...
        case "gpt-5-nano":   baseName = "GPT-5 nano"
        case "gpt-5-pro":    baseName = "GPT-5 pro"
        case "gpt-5.4":      baseName = "GPT-5.4"
        case "gpt-5.4-mini": baseName = "GPT-5.4 mini"
        case "gpt-5.4-nano": baseName = "GPT-5.4 nano"
        case "gpt-5.4-pro":  baseName = "GPT-5.4 pro"
        case "o1":           baseName = "o1"
